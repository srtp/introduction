        ...
        <div class="row">
            ...
            margin-left: 30px;" class="col-md-8">
                ...
                <h7> OrderID: <?php echo $rowdetail['order_id'] ?> <br>
                    ...
                    บ้านเลขที่: <?php echo $rowdetail['address'] ; ?> 
                     <br>
...
?>
                ...
                <div class=form-row >
                    ...
                    <div class="col-md-6">
                                <h6>Check Tracking</h6>
                                <form action="ems_db.php" method="post" class="form-horizontal">
                                    <div class="col-sm-2 control-label">
                                    </div>
                                    <div class="col-md-6" style="padding-left: 0px;">
                                        <input style="background-color:#95A5A6;
                                        color:#17202A; " type="text" name="o_ems" required minlength="4"
                                            placeholder="จะได้รับ tracking ภายใน 24 ช.ม." class="form-control"
                                            value="<?php echo $rowdetail['o_ems'] ;?>" disabled>
                                        <h6><?php echo $rowdetail['o_ems_date']?></h6>
                                        <br>
                                    </div>
                            </div>
                </div>
