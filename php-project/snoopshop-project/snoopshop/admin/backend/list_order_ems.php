...
<?php include('h.php');?>
<?php $queryorder = "SELECT * FROM tb_order WHERE order_status=3";
$rsorder = mysqli_query($con, $queryorder);
// echo $queryorder
// // echo '<pre>' ;
// // print_r($rowdetail);
?>
<h3>รายการที่จัดส่งเรียบร้อยแล้ว</h3>
...
<tr>
    ...
    <?php 
                $o_id= $row['order_id'];
                    echo "<a href='tracking_detail.php?order_id=$o_id&do=tracking_detail_token_uyiqaloz19mc234'class ='btn btn-info btn-sm'>ตรวจสอบ</a>";  
