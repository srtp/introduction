...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 03, 2020 at 09:19 AM
...
CREATE TABLE `amphures` (
  ...
  `name2_th` varchar(150) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `amphures` (`id`, `code`, `name2_th`, `name_en`, `province_id`) VALUES
...
CREATE TABLE `districts` (
  ...
  `name3_th` varchar(150) COLLATE utf8_bin NOT NULL,
...
INSERT INTO `districts` (`id`, `zip_code`, `name3_th`, `name_en`, `amphure_id`) VALUES
...
(18, 'adminshop', 'admin', 'Petchz', '2020-10-10 09:11:52'),
(19, 'petch', '1111', 'Petch', '2020-10-10 12:12:50');
...
CREATE TABLE `tbl_bank` (
  `bid` int(11) NOT NULL,
  `bname` varchar(150) CHARACTER SET utf8 NOT NULL,
  `bnumber` varchar(20) CHARACTER SET utf8 NOT NULL,
  `bowner` varchar(150) CHARACTER SET utf8 NOT NULL
...
(1, 'ไทยพาณิชย์', '99-999', 'บริษัท สนู๊ปช็อป จำกัด'),
(2, 'กสิกร', '88-888', 'บริษัท สนู๊ปช็อป จำกัด');
...
(15, 'member', 'aa08769cdcb26674c6706093503ff0a3', 'snoop', 'member@ba2na.com', '092092', 'asdasd    ', '2020-10-19 14:33:11'),
(16, 'member2', 'member', 'Petch', 'kdkk@ba2na.com', '88888', 'fkkfk  ', '2020-10-19 18:41:32'),
(20, 'member3', 'aa08769cdcb26674c6706093503ff0a3', 'atom', 'lll@gmail.com', '09999', 'sd', '2020-10-20 17:30:19'),
(21, 'srtp', '09be80650e7ef965c205b39647128c86', 'Settapak Thongyou', '', '0906239552', '11/33 บ้านสวน', '2020-10-24 17:19:59'),
(22, 'srtp1', '9c0fa1eaea10b0e42d5a67f94c254058', 'settapak', '', '09009232', 'dsfds', '2020-10-26 15:39:24'),
(23, 'petch11', '0c8a60c8f60882f1ba1ac6d8189c6708', 'youname', '', '09009232', 'jjdiddidd', '2020-10-27 06:15:16'),
(36, 'atom', '3e10f8c809242d3a0f94c18e7addb866', 'atom', '', '09898989', 'sdjhsdsd', '2020-11-03 05:51:34');
...
INSERT INTO `tbl_product` (`p_id`, `p_name`, `type_id`, `p_detail`, `p_img`, `datesave`, `p_price`) VALUES
(1, 'Hills Science Diet Adult Perfect Weight dog food 15 Kg', 1, 'แนะนำสำหรับ:\r\nสุนัข อายุ 1-6 ปี รวมไปถึงสุนัขที่มีความกระตือรือร้นน้อย สุนัขที่ทำหมันแล้ว หรือสุนัขที่มีแนวโน้มน้ำหนักเพิ่มขึ้น\r\n\r\nไม่แนะนำสำหรับ:\r\nลูกสุนัข สุนัขตั้งท้องหรือให้นม ระหว่างที่สุนัขตั้งท้องหรือให้นม                    ', 'p_img40220147720201030_170103.png', '2020-10-30 10:01:03', 1690),
(2, 'Hills Diet Hills  Youthful Vitality Adult 7+ 8 Kg', 1, 'สุนัขอายุ 7 ปีขึ้นไปของคุณ\r\n-ส่วนผสมอันเป็นสูตรเฉพาะที่ช่วยส่งเสริมการทำงานของสมอง เพิ่มการมีปฏิสัมพันธ์กับเจ้าของ ฟื้นฟูพละกำลัง และเพิ่มความมีชีวิตชีวา\r\n-กรดไขมันโอเมก้า 3 และโอเมก้า 6 เพื่อขนที่นุ่มสลวย\r\n-วัตถุดิบย่อยง่ายสำหรับสุขภาพที่ดีของทางเดินอาหาร', 'p_img117370931720201030_191540.png', '2020-10-30 12:15:40', 780),
(3, 'Hills Science Diet  Adult Light dog food 8kg', 1, 'สำหรับไลฟ์สไตล์ที่เบาและมีสุขภาพดี\r\n- แคลอรี่น้อยลง 18% จาก Adult Fitness Adult Advanced Fitness\r\n- ผลประโยชน์ต้านอนุมูลอิสระที่พิสูจน์ทางคลินิก\r\n- ไม่มีสีและรสเทียมหรือสารกันบูด\r\n\r\nแนะนำสำหรับ:\r\nสุนัขผู้ใหญ่ที่อายุ 1-6 ขวบ ต้องการแคลอรี่น้อยลง (เช่น สุนัขที่ไม่ค่อยมีกระตือรือร้น,ตัวที่ทำหมันแล้ว,หรือแนวโน้มที่จะมีน้ำหนักตัวเพิ่มขึ้น)', 'p_img78120980120201030_192020.png', '2020-10-30 12:20:20', 990),
(4, 'Hills  Diet  Adult Light Small Bites  8 Kg', 1, 'คุณค่าทางโภชนาการที่สมดุลในอาหารเม็ดขนาดเล็กเพื่อช่วยควบคุมน้ำหนักและมีไลฟ์สไตล์ที่ดี\r\n- แคลอรี่น้อยลง 18% จาก Adult Advanced Fitness\r\n- ผลประโยชน์ต้านอนุมูลอิสระที่พิสูจน์ทางคลินิก\r\n- ไม่มีสีและรสเทียม หรือสารกันบูด\r\n\r\nแนะนำสำหรับ:\r\nสุนัขผู้ใหญ่ที่อายุ 1-6 ปี ต้องการแคลอรีน้อยกว่า (เช่น สุนัขที่ไม่ค่อยคล่องตัว,เป็นหมัน หรือมีแนวโน้มที่จะมีน้ำหนักเพิ่มขึ้น)', 'p_img131591555920201030_192325.png', '2020-10-30 12:23:25', 800),
(5, 'Hills  Diet Puppy Small Paws 8 Kg', 1, 'อาหารสำหรับลูกสุนัขพันธุ์เล็กที่ออกแบบโภชนาการเพื่อพัฒนาการที่แข็งแรงของลูกสุนัขพันธุ์เล็ก ให่พวกเขามีจุเริ่มต้นที่ดีที่สุดและเติบโตอย่างเต็มที่ และอาหารถูกออกแบบให้มีขนาดเม็ดเล็กทานง่าย\r\n\r\nมี DHA จากน้ำมันปลาเพื่อพัฒนาการที่แข็งแรงของสมองและสายตา\r\nโปรตีนคุณภาพสูงเพื่อสร้างกล้ามเนื้อ\r\nมีแร่ธาตุที่สมดุลเพื่อกระดูกและฟันที่แข็งแรง\r\nมีสารต้านอนุมูลอิสระพิเศษสำหรับสุนัขพันธุ์เล็กเพื่อเสริมสร้างภูมิคุ้มกันที่ยืนยาว', 'p_img157880236720201030_192657.png', '2020-10-30 12:26:57', 890),
(6, 'Hills Diet Adult 7+ Small Bites  4 Kg', 1, 'ถูกออกแบบมาเพื่อความต้องการของสุนัขที่มีอายุมาก โดยมีสารอาหารที่ย่อยง่ายที่มาจากสาวนผสมต่างๆ ที่ทำงานร่วมกันเพื่อเสริมสร้างพลังงานและเพิ่มความกระตือรือร้นในการทำกิจกรรม รสชาติเนื้อไก่แสนอร่อยและเม็ดอาหารขนาดเล็กทานง่ายเหมาะสำหรับสุนัขช่างเลือก\r\n\r\nมีแร่ธาตุที่สมดุลเพื่อสุขภาพที่ดีของหัวใจและไต\r\nโอเมก้า 6 และวิตามินอี เพื่อผิวและขนสวยสุขภาพดี\r\nโปรตีนคุณภาพสูงเพื่อเสริมสร้างกล้ามเนื้อ\r\nแนะนำสำหรับ:\r\nสุนัข อายุ 7 ปีขึ้นไป', 'p_img143543779320201030_193037.png', '2020-10-30 12:30:37', 590),
(7, 'Hills Science Diet Adult 7+ 16 kg', 1, 'เป็นอาหารออกแบบมาสำหรับสุนัขที่อายุมากขึ้น มีสารอาหารที่ย่อยง่ายด้วยส่วนผสมต่างๆ ที่ทำงานสอดประสานกันอย่างลงตัว เพื่อเสริมสร้างพลังงานและความกระตือรือร้นในการทำกิจกรรมต่างๆ\r\n\r\nมีแร่ธาตุที่สมดุลเพื่อสุขภาพที่ของหัวใจและไต\r\nโอเมก้า 6 และวิตามินอี เพื่อผิวหนังและขนสวยสุขภาพดี\r\nโปรตีนคุณภาพสูงเพื่อเสริมสร้างกล้ามเนื้อ\r\nแนะนำสำหรับ:\r\nสุนัข อายุ 7 ปีขึ้นไป', 'p_img170430115720201030_193524.png', '2020-10-30 12:35:24', 1490),
(8, 'Hills Science Diet Adult 7+ Small Paws 8 Kg', 1, 'อาหารสุนัขพันธุ์เล็ก อายุ 7 ปีขึ้นไป เป็นอาหารที่มีโภชนาการที่ออกแบบมาเพื่อเจ้าตัวเล็กที่อายุมากของคุณโดยเฉพาะ อาหารถูกออกแบบให้มีขนาดเม็ดเล็ก และอุดมไปด้วยสารอาหารมากมายเพื่อให้พลังงานและความแข็งแรง\r\n\r\nมีแร่ธาตุที่สมดุลเพื่อสุขภาพที่ดีของ หัวใจ ไต และกระเพาะปัสสาวะ\r\nอุดมไปด้วย โอเมก้า 6 และวิตามินอี เพื่อให้ผิวหนังและขนสวยสุขภาพดี\r\nวัตถุดิบที่ย่อยง่ายเพิ่มสุขภาพที่ดีของทางเดินอาหาร\r\nมีสารต้านอนุมูลอิสระพิเศษสำหรับสุนัขพันธุ์เล็กเพื่อเสริมสร้างภูมิคุ้มกันในระยะยาว\r\nแนะนำสำหรับ:\r\nสุนัขอายุ 7 ปีขึ้นไป น้ำหนักเมื่อโดตเต็มวัยไม่เกิน 11 กก.', 'p_img141261256320201030_193658.png', '2020-10-30 12:36:58', 880),
(9, 'Royal Canin MINI ADULT 8+', 1, '                                                            Over 8 years old\r\n\r\nVITALITY SUPPORT\r\nThe content of nutrients in this formula helps maintain vitality in small breed dogs facing the first signs of ageing. Contains a patented complex of antioxidants.\r\n\r\nENHANCED PALATABILITY\r\nSatisfies the fussy appetite of small breed dogs by means of its formulation and a selection of exclusive flavourings.\r\n\r\nMAINTAINS IDEAL WEIGHT\r\nHelps maintain ideal weight in small breed dogs through promoting fat metabolism by L-carnitine.\r\n\r\nDENTAL HEALTH\r\nHelps reduce tartar formation thanks to the chelation agents in calcium.\r\n\r\nอาหารเม็ด\r\nPackaging size: 2.0 กก., 8.0 กก.                                                                                       ', '170658217820201030_220356.png', '2020-10-11 11:27:16', 300),
(10, 'Royal Canin MINI STARTER', 1, 'อาหารชนิดเม็ดสำหรับแม่สุนัขตั้งท้องและให้นมลูก และลูกสุนัขหลังหย่านมถึงอายุ 2 เดือน ซึ่งเป็นสุนัขพันธุ์เล็ก (น้ำหนักโตเต็มวัย 1 - 10 กก.)          \r\nSTART COMPLEX\r\nกลุ่มสารอาหารเฉพาะที่มีอยู่ในน้ำนมแม่สุนัขช่วยเสริมภูมิคุ้มกันตามธรรมชาติและดูแลระบบย่อยอาหาร\r\nดูแลแม่สุนัขช่วงตั้งท้อง และให้นม\r\nด้วยสารอาหารที่ตอบโจทย์ความต้องการพลังงานสูงในช่วงนี้\r\nปรับเป็นอาหารกึ่งเหลวได้\r\nเม็ดอาหารดูดซึมน้ำได้ง่าย สามารถปรับเป็นอาหารกึ่งเหลวได้เหมาะสำหรับลูกสุนัขช่วงหย่านมที่ฟันเพิ่งขึ้น\r\nส่วนผสม : ผลพลอยได้จากสัตว์ปีก, ข้าว, ไขมันสัตว์ (สุกร, สัตว์ปีก), โปรตีนสกัดจากถั่วเหลือง, ข้าวโพด,เยื่อหัวบีท, โปรตีนจากสัตว์ปีกไฮโดรไลซ์, แร่ธาตุ, น้ำมันปลา, น้ำมันถั่วเหลือง,ฟรุกโต-โอลิโก-แซคคาไรด์, เกลือกรดไขมัน,สารสกัดจากยีสต์ (แหล่งของแมนโน-โอลิโก-แซคคาไรด์ และเบต้า-กลูแคน), ไข่ผง,สารสกัดจากดอกดาวเรือง (แหล่งของลูทีน), วิตามิน, สารถนอมคุณภาพอาหารสัตว์\r\nคุณภาพของอาหารสัตว์ทางเคมี : โปรตีน ไม่น้อยกว่า 28%, ไขมัน ไม่น้อยกว่า 20%, กาก ไม่มากกว่า 2.3%, ความชื้น ไม่มากกว่า 9%  \r\nPackaging size: 1 กก.,3กก.,8.5 กก.                     ', '170822868720201030_220533.png', '2020-10-17 17:46:19', 399),
(11, 'Royal Canin GOLDEN JUNIOR (2-15 month)', 1, 'ลูกสุนัขพันธุ์โกลเด้น รีทรีฟเวอร์ 2 - 15 เดือน Golden Retriever Junior Skin & Coat Defence เพื่อสุขภาพผิวหนังและขนที่แข็งแรง Digestive Security Prebiotics & psyllium และโปรตีนย่อยง่ายสูง L.I.P. ช่วยให้การทำงานของระบบการย่อยดีขึ้น Bone & Joint Support ช่วยเสริมสร้างพัฒนาการและบำรุงกระดูก คอนดรอยตินและ กลูโคชามีน ช่วยบำรุงข้อต่อ Natural Defences เสริมสร้างระบบภูมิคุ้มกันตามธรรมชาติด้วยการทำงานร่วมกันของสารต้านอนุมูลอิสระ อาหารเม็ด Packaging \r\nsize: 3.0 กก., 12.0 กก.                          ', '197566605020201030_220749.png', '2020-10-19 15:49:36', 1039),
(12, 'Royal Canin LABRADOR JUNIOR  12 kg', 1, 'ลูกสุนัขพันธุ์ลาบราดอร์ รีทรีฟเวอร์ 2 - 15 เดือน \r\n\r\n Healthy Growth & Weight ป้องกันภาวะน้ำหนักเกิน ให้น้ำหนักอยู่ในระดับที่เหมาะสมตั้งแต่วัยเด็ก Digestive Health ช่วยรักษาสมดุลในลำไส้ Prebiotics & psyllium Natural Defences เสริมสร้างระบบภูมิคุ้มกันตามธรรมชาติด้วยการทำงานร่วมกันของสารต้านอนุมูลอิสระ Healthy Skin & Beautiful Coat เพื่อสุขภาพผิวหนังที่ดีและเส้นขนให้สวยเงางาม อาหารเม็ด Packaging                                       ', '184143271020201030_220927.png', '2020-10-19 15:55:02', 1790),
(13, 'Royal Canin MINI STARTER 2', 1, '             ', '143307677120201030_221329.png', '2020-10-20 06:23:22', 1900),
(14, 'Royal Canin MEDIUM ADULT', 1, 'อาหารชนิดเปียกสำหรับสุนัขพันธุ์กลาง (น้ำหนักโตเต็มวัย 11 - 25 กก.) อายุ 12 เดือน – 10 ปี\r\nดูแลระบบทางเดินอาหาร และปรับสมดุลแบคทีเรียในลำไส้\r\nเสริมสร้างภูมิคุ้มกันตามธรรมชาติด้วยกลุ่มสารต้านอนุมูลอิสระ และพรีไบโอติกส์                            \r\nขนสวยสุขภาพดี ด้วยกลุ่มสารอาหารดูแลผิว และ EPA-DHA       \r\nส่วนผสม : เนื้อไก่   ไตสุกร   ตับสุกร   น้ำมันเมล็ดทานตะวัน    ตับไก่     กลูเทนข้าวสาลี   ข้าว    แป้งข้าวโพด    เซลลูโลส     แร่ธาตุ   วิตามิน     น้ำมันปลา   สารปรุงแต่งอาหารสัตว์ (ไคลน็อพทิโลไลท์)    ยีสต์   สารเพิ่มความหนืดจากคาร็อบกัม   คาราเมล   ดอกดาวเรืองป่น   \r\nคุณภาพของอาหารสัตว์ทางเคมี : โปรตีน ไม่น้อยกว่า 5.5%, ไขมัน ไม่น้อยกว่า 3.5%, กาก ไม่มากกว่า 2.1%, ความชื้น ไม่มากกว่า 82%              ', '1897328120201030_222137.png', '2020-10-24 10:44:17', 330),
(15, 'Royal Canin MINI PUPY', 1, '                          ', '43278015320201030_222152.png', '2020-10-24 12:49:02', 295),
(16, 'Royal Canin BULLDOG ADULT', 1, '             ', '175633730020201030_222205.png', '2020-10-24 12:55:42', 330),
(17, 'Royal Canin BEAGLE  ADULT', 1, '                          ', '114628691520201030_222219.png', '2020-10-24 13:01:18', 330),
(18, 'Royal Canin MAXI PUPY', 1, '             ', '137761351520201030_222236.png', '2020-10-24 13:12:39', 330),
(19, 'Royal Canin MEDIUM DERMACOMFORT', 1, '             ', '41335843420201030_222250.png', '2020-10-24 13:53:48', 1250),
(20, 'Royal Canin MEDIUM ADULT 7+', 1, '                                       ', '156607861520201030_222302.png', '2020-10-24 14:00:02', 1490),
(37, ' Hills Science Diet Adult Chicken Recipe cat  6 Kg', 2, 'อาหารแมว  มีสูตรพิเศษเพื่อให้พลังงานที่แมวต้องการในช่วงวัยอายุ 1-6 ปี ผลิตจากวัตถุดิบคุณภาพสูงและย่อยง่าย\r\n\r\nมี ทอรีน เพื่อสุขภาพที่ดีของหัวใจ และมีแร่ธาตุที่สมดุลเพื่อสุขภาพที่ดีของไต และกระเพาะปัสสาวะ\r\nมีโปรตีนคุณภาพสูงเพื่อเสริมสร้างกล้ามเนื้อ\r\nวิตามินอี โอเมก้า 3 และโอเมก้า 6 เพื่อผิวและขนสวยสุขภาพดี\r\nแนะนำสำหรับ:\r\nแมวอายุ 1-6 ปี             ', 'p_img201235420920201030_195045.png', '2020-10-30 12:50:45', 690),
(38, 'Hills Science Diet Adult Indoor cat food 6 kg', 2, 'มีสูตรพิเศษเพื่อให้พลังงานสำหรับแมว อายุ 1-6 ปีที่เลี้ยงในบ้าน\r\n\r\nใยอาหารจากธรรมชาติและวัตถุดิบคุณภาพสูงช่วยเสริมสร้างสุขภาพระบบการขับถ่ายที่ดี ให้เจ้าของสามารถทำความสะอาดกระบะทรายได้ง่าย\r\nโปรตีนคุณภาพสูงเพื่อสร้างกล้ามเนื้อ\r\nอาหารผลิตจากส่วนผสมที่อร่อย ย่อยง่าย มีคุณภาพสูง และผลิตจากธรรมชาติ\r\nแนะนำสำหรับ:\r\nแมว อายุ 1-6 ปี ที่เลี้ยงในบ้าน', 'p_img208007544320201030_210745.png', '2020-10-30 14:07:45', 690),
(39, 'Hills Science Diet Adult 7+ Indoor cat food', 2, 'มีสูตรพิเศษเพื่อให้พลังงานกับแมวอายุมากที่เลี้ยงในบ้านต้องการ\r\n\r\nสูตรพิเศษเพื่อให้พลังงานกับแมวอายุมากที่เลี้ยงในบ้านต้องการ\r\nใยอาหารจากธรรมชาติและวัตถุดิบคุณภาพสูงช่วยเสริมสร้างสุขภาพระบบการขับถ่ายที่ดี ให้เจ้าของสามารถทำความสะอาดกระบะทรายได้ง่าย\r\nโปรตีนคุณภาพสูงเพื่อสร้างกล้ามเนื้อ\r\nอาหารผลิตจากส่วนผสมที่อร่อย ย่อยง่าย มีคุณภาพสูง และผลิตจากธรรมชาติ\r\nแนะนำสำหรับ:\r\nแมว อายุมากกว่า 7 ปี ที่เลี้ยงในบ้าน', 'p_img26309599720201030_210954.png', '2020-10-30 14:09:54', 740),
(40, 'Hills Science Diet Adult Chicken Recipe cat food 6 Kg', 2, 'มีสูตรพิเศษเพื่อให้พลังงานที่แมวต้องการในช่วงวัยอายุ 1-6 ปี ผลิตจากวัตถุดิบคุณภาพสูงและย่อยง่าย\r\n\r\nมี ทอรีน เพื่อสุขภาพที่ดีของหัวใจ และมีแร่ธาตุที่สมดุลเพื่อสุขภาพที่ดีของไต และกระเพาะปัสสาวะ\r\nมีโปรตีนคุณภาพสูงเพื่อเสริมสร้างกล้ามเนื้อ\r\nวิตามินอี โอเมก้า 3 และโอเมก้า 6 เพื่อผิวและขนสวยสุขภาพดี', 'p_img17325195220201030_211346.png', '2020-10-30 14:13:46', 500),
(41, 'Hills Science Diet Mutiple Benefit', 2, 'ได้รับการคิดค้นสูตรมาอย่างดี เพื่อพัฒนาการของลูกแมว เพื่อพวกเขาจะมีจุดเริ่มต้นของชีวิตที่ดีที่สุดและเติบโตได้อย่างเต็มที่\r\n\r\nมี DHA จากน้ำมันปลาเพื่อพัฒนาการของสมองและสายตา\r\nโปรตีนคุณภาพสูงเพื่อสร้างกล้ามเนื้อ\r\nมีแร่ธาตุที่สมดุลเพื่อกระดูกและฟันที่แข็งแรง', 'p_img201978087920201030_212029.png', '2020-10-30 14:20:29', 290),
(42, 'Zoi Cat สำหรับแมวทุกสายพันธ์ 6 Kg', 2, 'เหมาะสำหรับแมวทุกวัย', 'p_img40114798720201030_212247.png', '2020-10-30 14:22:47', 450),
(43, 'Kit Cat Kitten & Pregnat Cat 3 Kg', 2, '', 'p_img134461219820201030_212501.png', '2020-10-30 14:25:01', 290),
(44, 'IAMS FOOD CAT เพื่อสุขภาพแมวที่ดี  6 Kg', 2, '', 'p_img202620718020201030_212906.png', '2020-10-30 14:29:06', 599),
(45, 'Me-o สำหรับลูกแมว 3 Kg', 2, '', 'p_img29580925820201030_213325.png', '2020-10-30 14:33:25', 200),
(46, 'ADVANCE ADULT INDOOR CAT 3kg', 2, 'สินค้านำเข้าจาก USA \r\nผลิตจากวัตถุดิบคุณภาพสูงและย่อยง่าย\r\n\r\nมี ทอรีน เพื่อสุขภาพที่ดีของหัวใจ และมีแร่ธาตุที่สมดุลเพื่อสุขภาพที่ดีของไต และกระเพาะปัสสาวะ\r\nมีโปรตีนคุณภาพสูงเพื่อเสริมสร้างกล้ามเนื้อ\r\nวิตามินอี โอเมก้า 3 และโอเมก้า 6 เพื่อผิวและขนสวยสุขภาพดี\r\nแนะนำสำหรับ:\r\nแมวอายุ 1-6 ปี', 'p_img52660798020201030_213908.png', '2020-10-30 14:39:08', 800);
...
(1, 'อาหารสุนัข ชนิด : เม็ด'),
(2, 'อาหารแมว ชนิด : เม็ด');
...
CREATE TABLE `tb_order` (
  ...
  `subdist_id` int(20) NOT NULL,
  `zip_code` int(11) DEFAULT NULL,
  `email` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `phone` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  `order_status` int(1) NOT NULL COMMENT '1=รอชำระเงิน 2=ชำระเงินแล้ว 3=ตรวจสอบเลข EMS 4=ยกเลิก',
  `bid` int(2) NOT NULL DEFAULT 0 COMMENT 'ไอดีธนาคาร',
  `o_slip` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `o_slip_date` date NOT NULL,
  `o_slip_total` float(10,2) DEFAULT 0.00,
...
INSERT INTO `tb_order` (`order_id`, `m_user`, `name`, `address`, `prov_id`, `dist_id`, `subdist_id`, `zip_code`, `email`, `phone`, `order_status`, `bid`, `o_slip`, `o_slip_date`, `o_slip_total`, `o_ems`, `o_ems_date`, `total`, `order_date`) VALUES
(1, 'atom', 'เศรษฐภาคย์ ทองอยู่', 'ชลบุรี .......', 0, 0, 0, 0, 'skajd@gmail.com', '09088989', 3, 2, 'slip124801869720201103_125452.jpg', '2020-11-03', 5520.00, 'XSGUHX66788', '2020-11-03 12:57:03', 2760, '2020-11-03 12:53:07'),
(2, 'atom', 'เศรษฐภาคย์ ทองอยู่', 'sdasa', 0, 0, 0, 0, 'skajd@gmail.com', '09088989', 4, 0, '', '0000-00-00', 0.00, '', '0000-00-00 00:00:00', 780, '2020-10-27 12:58:44');
