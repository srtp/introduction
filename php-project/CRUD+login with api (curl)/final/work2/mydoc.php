...
<?php
      ...
      $email = $_SESSION['email'];
                ...
                $query = "SELECT * FROM tbl_doc WHERE email LIKE '$email' AND status=2 ORDER BY doc_id ASC" or die("Error:" . mysqli_error());
                ...
                echo ' <table class="table table-hover" >';
                  ...
                  echo "<tr class='mydoc4'>";
                    ...
                    echo "<td>" .$row["run_no"] .  "</td> ";
                     ...
                     $doc_id= $row['doc_id'];
                    //แก้ไขข้อมูล
                    echo '<td><a href="send.php?doc_id='.$doc_id.'" class="btn btn-success btn-sm">ส่งเอกสาร</a>';  
                    //ลบข้อมูล
      ...
      $email = $_SESSION['email'];
                ...
                $query = "SELECT * FROM tbl_doc WHERE level = $level AND status=2 ORDER BY doc_id ASC" or die("Error:" . mysqli_error());
                $result = mysqli_query($conn, $query);
                ...
                echo ' <table class="table table-hover" >';
                  ...
                  echo "<tr class='mydoc4'>";
                    ...
                    //แก้ไขข้อมูล
                    echo '<td><a href="send2.php?doc_id='.$doc_id.'" class="btn btn-success btn-sm">ส่งเอกสาร</a>';  
                    //ลบข้อมูล
                    echo '<td><a href="send.php?doc_id=$doc_id" class="btn btn-danger btn-sm">Delete</a>';
                  echo "</tr>";
                  }
